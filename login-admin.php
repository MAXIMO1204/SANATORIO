    ...
    <button class="btn-close" onclick="window.location.href='principal.php'">X</button>
            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="php/entrada-admin.php" method="POST" class="formulario__login">
    <h3>CENTRO MEDICO GRIERSON</h3>
    <h2>Iniciar Sesión</h2>
    <input type="text" placeholder="Usuario" name="administrador" required>
...
function togglePasswordVisibility() {
    ...
    if (passwordInput.type === "password") {
        ...
        icon.classList.add("feather-eye");
                    ...
                    <!--Register-->
                    <form action="php/registro-admin.php" method="POST" class="formulario__register">
                        <h3>CENTRO MEDICO GRIERSON</h3>
                        <h4>Regístro de Administrador</h4>
                        <input type="text" placeholder="Nombre completo" name="nombre">
                        <input type="text" placeholder="ID" name="id">                      
                        <input type="text" placeholder="Usuario"name="administrador">
